...
int TAP_VALUES[4] = {63, 31, 0, 0}; //stores the tap position values 0-63, 0-31 = Left Register; 32-63 = Right Register;
...
//BYTE_1 of 11111111 allows direct setting of the register. The next eight bytes are loaded into BYTE_1 where the frist byte received is = 0 - 7
...
void displayRegisters(){
  ...
  for(int i = 0 ; i < REGISTER_SIZE/2 ; i++){
    PORTB = (REG_STATES[31-i] ^ REG_STATES[32+i]) << 3; //digitalWrite(OUTPUT_REG_DATA, );
